 ...
 */
export const fees = {
  short: 'منصة سنون ما تاخذ فلوس لا من المراجع ولا من الطالب.',
  long:
...
export const howItWorks = {
  ...
  steps: [
    ...
    'الطالب الموثّق يشوف الحالات ويقدر يحجز منها.',
...
export const home = {
  ...
  headlineAccent: 'نوصّل بين المراجعين',
  headlineRest: 'وطلاب طب الأسنان',
  subhead:
    'منصة توصّل بين طلاب طب الأسنان اللي يشتغلون حالات بالجامعة، والمراجعين اللي يريدون علاج أسنان. العلاج يصير بعيادة الجامعة وتحت إشراف كادر مختص.',
  ...
  promises: [
    { title: 'مجاني تماماً', body: 'منصة سنون ما تاخذ فلوس لا من المراجع ولا من الطالب.' },
    { title: 'سريع', body: 'المراجع يقدر يقدّم حالته برابط واحد، وما يحتاج تسجيل.' },
    { title: 'تحت إشراف', body: 'العلاج يتم بعيادة الجامعة وبإشراف كادر طبي مختص، ويقدّمه الطلاب.' },
  ],
...
export const bridge = {
  ...
  patient: 'مراجع',
  name: 'سنون',
  caption: 'منصة سنون توصّل بين الطلاب والمراجعين. المنصة نفسها ما توفّر علاج ولا توظّف أحد.',
  alt: 'رسم: طالب طب أسنان من جهة، ومراجع من الجهة الثانية، وبينهما خط منحني يوصلهما وعليه اسم سنون.',
} as const
...
export const treatmentsSection = {
  eyebrow: 'الخدمات المقدّمة',
  title: 'شنو تكدر تعالج وية سنون؟',
  body: 'هذي الخدمات اللي يقدر يقدّمها الطالب بعيادة الجامعة. اختار وحدة أو أكثر حسب احتياجك.',
} as const
...
export const safetySection = {
  eyebrow: 'خصوصيتك',
  /** The big line, and a quieter one under it. */
  title: 'خصوصيتك تهمّنا',
  subtitle: 'شنو يصير بمعلوماتك',
  points: [
    {
      title: 'رقمك بأمان',
...
export const faqSection = {
  ...
  items: [
    ...
    {
      q: 'منو راح يعالجني؟',
      a: 'طالب طب أسنان بالسنة الرابعة أو الخامسة، داخل عيادة جامعته وتحت إشراف الأساتذة. الطلبة يحتاجون حالات حتى يكملون متطلبات دراستهم، وهواي مراجعين يحتاجون عناية أسنان بأسعار رمزية أو مجاناً. هذا سبب وجود سنون.',
    },
    {
      q: 'أحتاج أسوي حساب؟',
